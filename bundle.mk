...
dist:
	...
	cd dist/working/CPyCppyy-1.12.6/ && PYTHONPATH=../../homemaker/libs/site/packages python setup.py build && cp -r build/lib.*/* ../../homemaker/libs/site/packages/
	# FIXME CPyCppyy isn't picked-up need to set CPPYY_API_PATH
	...
	cp /usr/lib64/libTopologicCore.so.0 dist/homemaker/libs/

	# opencascade
	# FIXME this is copying the installed fedora RPM
	cp /usr/lib64/libTK*.so.7 dist/homemaker/libs/
