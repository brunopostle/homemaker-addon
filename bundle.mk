...
dist:
	...
	cp -r molior/ topologist/ __init__.py widgets.blend dist/homemaker/
	...
	cd dist/working && wget https://github.com/brunopostle/Topologic/releases/download/2021-10-28/Topologic_2021-10-28_buster.zip
	...
	strip dist/homemaker/libs/site/packages/ezdxf/acc/*.so
	...
	strip dist/homemaker/libs/site/packages/yaml/*.so
